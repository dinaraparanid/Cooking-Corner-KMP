...
interface RecipeEditorStore : Store<UiIntent, State, Label> {
    sealed interface UiIntent {
        ...
        data object PickThubnail : UiIntent
        ...
        data class UpdateCategory(val category: String) : UiIntent
        data class UpdateTag(val tag: String) : UiIntent
